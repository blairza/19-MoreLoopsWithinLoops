...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 4
    answer = largest_number(([1,1,2],[2,3,4]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    expected = -10
    actual = largest_negative_number(([1,2,-10],[2,4,-5]))
    print('Expected and actual are:', expected,actual)

    expected = -20
    actual = largest_negative_number(([1,-20,-10],[2,4,-5]))
    print('Expected and actual are:', expected,actual)

    expected = -1
    actual = largest_negative_number(([1,2,10],[2,4,15],[-1,2,1]))
    print('Expected and actual are:', expected,actual)
